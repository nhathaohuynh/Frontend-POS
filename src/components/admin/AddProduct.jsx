...
import { addNewProductAction } from '../../redux/actions/product.action'
			...
			>
				<form class=' mx-auto'>
					...
					<div>
							...
							{product?.thumnail && (
								<div className='my-1'>
									<img
										...
										src={URL.createObjectURL(product?.thumnail)}
									/>
								</div>
							)}
						</div>
						...
						<Button onClickButton={onSubmitAddNewProduct}>Add Product</Button>
					</div>
				</form>
			</div>
		</div>
